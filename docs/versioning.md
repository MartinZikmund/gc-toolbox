...
| `wasm-deploy.yml` | push: release/v*, PR: main | Prod on release/v*, Dev on PR previews | release/v* → live Cloudflare Worker; PRs → `pr-<number>` preview version (public repos only). See [deployment.md](deployment.md) |
